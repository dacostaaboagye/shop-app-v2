...
import { fetchWorkerInvoice, invoiceQueryKey } from "@/lib/react-query/pos-sales";
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        description="Official sales document with print, download, and share actions."
        title={reference}
      />
    ...
    <div className="flex max-w-2xl flex-col gap-4">
      ...
      <div className="flex flex-wrap gap-2">
        <SalesDocumentActions
          ...
          profile={profile}
        />
        <Link className={buttonVariants({ size: "sm" })} href={toRoute("/worker/sales")}>
