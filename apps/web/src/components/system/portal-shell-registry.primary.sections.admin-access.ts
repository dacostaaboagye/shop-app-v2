...
export const ADMIN_ACCESS_NAV_REGISTRY: readonly NavRegistryEntry[] = [
  ...
  {
    activeMatchers: [{ mode: "exact", path: "/admin/staff/new" }],
    description: "Add a workforce staff member.",
  ...
  {
    activeMatchers: [{ mode: "exact", path: "/admin/access/users/new" }],
    description: "Create an internal workforce user account.",
    href: toRoute("/admin/access/users/new"),
    icon: Users,
    label: "New user",
    locationSelectorPermission: null,
    requiredPermission: "access.assignments.manage",
