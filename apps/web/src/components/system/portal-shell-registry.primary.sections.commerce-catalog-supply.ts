...
export const COMMERCE_CATALOG_SUPPLY_NAV_REGISTRY: readonly NavRegistryEntry[] =
  [
    ...
    },
    {
      ...
      description:
        "Global on-hand, reserved, and available stock across locations.",
      href: toRoute("/admin/stock/balances"),
      icon: Boxes,
      label: "Global stock levels",
      locationSelectorPermission: null,
      requiredPermission: "admin.dashboard.view",
      section: "Supply",
    },
    {
      activeMatchers: [{ mode: "descendants", path: "/admin/stock/movements" }],
      description:
        "Trace stock changes across locations, SKUs, and source references.",
      href: toRoute("/admin/stock/movements"),
      icon: History,
    ...
    },
    {
      ...
      description:
        "Generate and review stock-take sessions across all locations.",
      href: toRoute("/admin/stock/takes"),
      icon: ClipboardList,
      label: "Global stock-takes",
      locationSelectorPermission: null,
